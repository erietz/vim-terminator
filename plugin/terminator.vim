...
command! TerminatorRunFileInTerminal call terminator#jobs#run_file("terminal", expand("%"))
command! TerminatorRunFileInOutputBuffer call terminator#jobs#run_file("output_buffer", expand("%"))
...
command! -range TerminatorRunPartOfFileInTerminal call terminator#jobs#run_part_of_file("terminal", terminator#util#get_visual_selection())
command! -range TerminatorRunPartOfFileInOutputBuffer call terminator#jobs#run_part_of_file("output_buffer", terminator#util#get_visual_selection())
